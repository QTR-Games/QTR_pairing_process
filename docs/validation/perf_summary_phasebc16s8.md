...
| --- | ---: | ---: | ---: | ---: | --- | ---: | ---: |
| startup.select_database | 3.26 | 5.69 | +74.54% | +5% | FAIL | 5 | 5 |
| startup.initialize_ui_vars | 685.95 | 473.35 | -30.99% | +5% | PASS | 5 | 5 |
| startup.populate_dropdowns | 0.84 | 8.17 | +872.62% | +5% | FAIL | 5 | 5 |
| startup.create_ui_grids | 79.87 | 29.49 | -63.08% | +5% | PASS | 5 | 5 |
| sort.cumulative (apply_combined) | 3208.06 | 1535.10 | -52.15% | +10% | PASS | 5 | 5 |
| sort.confidence (apply_combined) | 5707.03 | 6382.79 | +11.84% | +10% | WARN | 5 | 5 |
| sort.counter/resistance (apply_combined) | 3877.05 | 5768.93 | +48.80% | +10% | FAIL | 5 | 5 |
| sort.strategic (strategic.sort.end_to_end) | 15595.67 | 22638.63 | +45.16% | +10% | FAIL | 5 | 5 |
## Interpretation
...
- Generated at: 2026-03-23 15:15:00
- Log directory: docs\validation\perf_capture_phasebc16s8_eval
- Selection mode: explicit globs (baseline_*.log) vs (new_*.log)
