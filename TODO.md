...
- [ ] Add a Data Management dropdown to select the visible right-column panel (default: Notes/Plan) and persist to KONFIG.
- [ ] Implement per RIGHT_COLUMN_PANELS_PLAN.md.