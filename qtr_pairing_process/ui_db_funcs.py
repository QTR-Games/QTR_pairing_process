...
class UIDBFuncs:
    def __init__(
        ...
        self.select_team_names = select_team_names
    ...
    def select_team_names(self):
        ...
        teams = DbManager.query_sql(self,sql)
    ...
    def add_team_to_db(self):
        ...
        if team_name:
            DbManager.create_team(self,team_name)
        popup.destroy()
        self.update_ui()
    ...
    def import_csvs(self):
        ...
        UIDBFuncs.import_csv_header_and_ratings(self,lines)
